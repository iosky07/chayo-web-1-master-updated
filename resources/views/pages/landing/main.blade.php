...
<head>
    ...
    <link href={{asset("template-assets/assets/vendor/boxicons/css/boxicons.min.css")}} rel="stylesheet">
    <link href={{asset("template-assets/assets/vendor/glightbox/css/glightbox.min.css")}} rel="stylesheet">
    <link href={{asset("template-assets/assets/vendor/remixicon/remixicon.css")}} rel="stylesheet">
    <link href={{asset("template-assets/assets/vendor/swiper/swiper-bundle.min.css")}} rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href={{asset("template-assets/assets/css/style.css")}} rel="stylesheet">
