...
{{--            <a href="{{ route('single-blog') }}" class="col-sm-6 col-lg-4 text-decoration-none project marketing social business">--}}
{{--                <div class="service-work overflow-hidden card mb-5 mx-5 m-sm-0">--}}
{{--                    <img class="card-img-top" src="{{asset("template-assets/img/our-work-01.jpg")}}" alt="...">--}}
{{--                    <div class="card-body">--}}
...
{{--                </div>--}}
{{--            </a>--}}
{{--            <a href="{{ route('single-blog') }}" class="col-sm-6 col-lg-4 text-decoration-none project graphic social">--}}
{{--                <div class="service-work overflow-hidden card mx-5 mx-sm-0 mb-5">--}}
{{--                    <img class="card-img-top" src="{{asset("template-assets/img/our-work-02.jpg")}}" alt="...">--}}
{{--                    <div class="card-body">--}}
...
{{--                </div>--}}
{{--            </a>--}}
{{--            <a href="{{ route('single-blog') }}" class="col-sm-6 col-lg-4 text-decoration-none project marketing graphic business">--}}
{{--                <div class="service-work overflow-hidden card mx-5 mx-sm-0 mb-5">--}}
{{--                    <img class="card-img-top" src="{{asset("template-assets/img/our-work-03.jpg")}}" alt="...">--}}
{{--                    <div class="card-body">--}}
...
{{--                </div>--}}
{{--            </a>--}}
{{--            <a href="{{ route('single-blog') }}" class="col-sm-6 col-lg-4 text-decoration-none project social business">--}}
{{--                <div class="service-work overflow-hidden card mx-5 mx-sm-0 mb-5">--}}
{{--                    <img class="card-img-top" src="{{asset("template-assets/img/our-work-04.jpg")}}" alt="...">--}}
{{--                    <div class="card-body">--}}
...
{{--                </div>--}}
{{--            </a>--}}
{{--            <a href="{{ route('single-blog') }}" class="col-sm-6 col-lg-4 text-decoration-none project marketing">--}}
{{--                <div class="service-work overflow-hidden card mx-5 mx-sm-0 mb-5">--}}
{{--                    <img class="card-img-top" src="{{asset("template-assets/img/our-work-05.jpg")}}" alt="...">--}}
{{--                    <div class="card-body">--}}
...
{{--                </div>--}}
{{--            </a>--}}
{{--            <a href="{{ route('single-blog') }}" class="col-sm-6 col-lg-4 text-decoration-none project marketing graphic">--}}
{{--                <div class="service-work overflow-hidden card mx-5 mx-sm-0 mb-5">--}}
{{--                    <img class="card-img-top" src="{{asset("template-assets/img/our-work-06.jpg")}}" alt="...">--}}
{{--                    <div class="card-body">--}}
        ...
        <div class="feature-work container my-4">
            <div class="row d-flex d-flex align-items-center">
                ...
                <div class="col-lg-6 offset-lg-1 align-left">
                    <div class="row">
                        <a class="col" data-type="image" data-fslightbox="gallery" href="{{asset("template-assets/img/feature-work-1-large.jpg")}}">
                            <img class="img-fluid" src="{{asset("template-assets/img/feature-work-1.jpg")}}">
                        </a>
                        <a class="col" data-type="image" data-fslightbox="gallery" href="{{asset("template-assets/img/feature-work-2-large.jpg")}}">
                            <img class="img-fluid" src="{{asset("template-assets/img/feature-work-2.jpg")}}">
                        </a>
                    </div>
                    <div class="row pt-4">
                        <a class="col" data-type="image" data-fslightbox="gallery" href="{{asset("template-assets/img/feature-work-3-large.jpg")}}">
                            <img class="img-fluid" src="{{asset("template-assets/img/feature-work-3.jpg")}}">
                        </a>
                        <a class="col" data-type="image" data-fslightbox="gallery" href="{{asset("template-assets/img/feature-work-4-large.jpg")}}">
                            <img class="img-fluid" src="{{asset("template-assets/img/feature-work-4.jpg")}}">
                        </a>
                    </div>
                </div>
            </div>
