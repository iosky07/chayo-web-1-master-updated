    ...
    <section class="container py-5">
        ...
        <div class="row justify-content-center pb-4">
            <div class="col-lg-8">
                <div id="templatemo-slide-link-target" class="card mb-3">
                    <img class="img-fluid border rounded" src="{{asset("template-assets/img/work-slide-04.jpg")}}" alt="Card image cap">
                </div>
                    ...
                    <div id="multi-item-example" class="col-10 carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col">
                                        <a class="templatemo-slide-link" href="{{asset("template-assets/img/work-slide-06.jpg")}}">
                                            <img class="img-fluid border rounded" src="{{asset("template-assets/img/work-slide-06-small.jpg")}}" alt="Product Image">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="templatemo-slide-link" href="{{asset("template-assets/img/work-slide-05.jpg")}}">
                                            <img class="img-fluid border rounded" src="{{asset("template-assets/img/work-slide-05-small.jpg")}}" alt="Product Image">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="templatemo-slide-link" href="{{asset("template-assets/img/work-slide-04.jpg")}}">
                                            <img class="img-fluid border rounded" src="{{asset("template-assets/img/work-slide-04-small.jpg")}}" alt="Product Image">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="templatemo-slide-link" href="{{asset("template-assets/img/work-slide-03.jpg")}}">
                                            <img class="img-fluid border rounded" src="{{asset("template-assets/img/work-slide-03-small.jpg")}}" alt="Product Image">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="templatemo-slide-link" href="{{asset("template-assets/img/work-slide-01.jpg")}}">
                                            <img class="img-fluid border rounded" src="{{asset("template-assets/img/work-slide-01-small.jpg")}}" alt="Product Image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <a class="templatemo-slide-link" href="{{asset("template-assets/img/work-slide-02.jpg")}}">
                                            <img class="img-fluid border rounded" src="{{asset("template-assets/img/work-slide-02-small.jpg")}}" alt="Product Image">
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="templatemo-slide-link" href="{{asset("template-assets/img/work-slide-01.jpg")}}">
        ...
        <div class="row pb-4">
            <div class="worksingle-comment-body col-md-8 m-auto">
                <div class="d-flex">
                    <div>
                        <img class="rounded-circle" src="{{asset("template-assets/img/team-05.jpg")}}" style="width: 50px;">
                    </div>
        ...
        <div class="row pb-4">
            <div class="col-lg-8 m-auto">
                <div class="d-flex">
                    <div>
                        <img class="rounded-circle" src="{{asset("template-assets/img/team-01.jpg")}}" style="width: 50px;">
                    </div>
                    <div class="comment-body">
                        <div class="comment-header d-flex justify-content-between ms-3">
                            <div class="header text-start">
                    ...
                    <div class="row gx-5">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-5">
                            <a href="#" class="related-content card text-decoration-none overflow-hidden h-100">
                                <img class="related-img card-img-top" src="{{asset("template-assets/img/related-post-01.jpg")}}" alt="Card image cap">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-5">
                            <a href="#" class="related-content card text-decoration-none overflow-hidden h-100">
                                <img class="related-img card-img-top" src="{{asset("template-assets/img/related-post-02.jpg")}}" alt="Card image cap">
                                <div class="related-body card-body p-4">
                        ...
                        <div class="col-sm-6 col-lg-4 mb-5">
                            <a href="#" class="related-content card text-decoration-none overflow-hidden h-100">
                                <img class="related-img card-img-top" src="{{asset("template-assets/img/related-post-03.jpg")}}" alt="Card image cap">
                                <div class="related-body card-body p-4">
                                    <h5 class="card-title h6 m-0 semi-bold-600 text-dark">Digital Marketing</h5>
                                    <p class="card-text pt-2 mb-1 light-300 text-dark">
